...
public class Exercise39_LinearProbingDistribution {
    private class LinearProbbingHashTableAvgSearchMissCost<Key, Value> extends LinearProbingHashTable<Key, Value> {


        public LinearProbbingHashTableAvgSearchMissCost(int size) {
            super(size);
        }
    ...
    private void doExperiment() {
        ...
        for (int hashTableSizeIndex = 0; hashTableSizeIndex < hashTableSizes.length; hashTableSizeIndex++) {
            ...
            LinearProbbingHashTableAvgSearchMissCost<Integer, Integer> linearProbingHashTableAvgSearchMissCost =
                    new LinearProbbingHashTableAvgSearchMissCost<>(hashTableSize);
